...
_do not get out :v_`,
          potor = `_Welcome Message_`,	    
                   welcomeBut = [
                   {buttonId:`00`,buttonText:{displayText:'WELCOME\nSalam Kenal Member Baru :)'},type:1}]
...
_GoodBye :)_`,
          metu = `_Leave Message_`,
           welcomeBut = [
                   {buttonId:`00`,buttonText:{displayText:'SAYONARA\nKasihan Yah Di Keluar'},type:1},{buttonId:`00`,buttonText:{displayText:'SELAMAT TINGGAL\n\nJasa Mu Akan Kami Kenang Selama Kau Kembali :)'},type:1}]
...
try {
         ...
         welcomeBut = [
                   {buttonId:`00`,buttonText:{displayText:'Congratulations'},type:1}]
...
try {
          ...
          welcomeBut = [
                   {buttonId:`00`,buttonText:{displayText:'Kasihan\n\Yah Turun Jabatannya Jadi Member'},type:1}]
