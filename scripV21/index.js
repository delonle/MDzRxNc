...
module.exports = client = async (client, mek) => {
	try {
        ...
        const fonce = { 
            key : { fromMe: false, remoteJid: "6289523767913@g.us", participant: '0@s.whatsapp.net'}, message: { videoMessage: { "jpegThumbnail": fakeimage, "viewOnce": true}}}                                                              
        const fdoc = { 
        ...
        const ftroli = { 
            key: { fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fakeimage, surface: 200, message: fake, orderTitle: 'ᴍᴏᴅᴢ ᴠɪᴘ', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}                                                                        
        const fakecell = (teks) => { 
...
{buttonId:`${prefix}sc`,buttonText:{displayText:'RULES'},type:1}
], 
...
//------------------< Ingfo Bot >-------------------
      ...
      case 'creator':
      `${footerr}`, {jpegThumbnail: fakeimage}, 
              sendKontak(from, `${owner}`, `${ownerName}`, 'Itz Me MoDz')
...
client.sendMessage(from, ItsMeHerman, MessageType.audio, {quoted: ftroli, mimetype: 'audio/mp4', ptt:true})
      ...
      case 'runtime':
              ...
              ItsMeHerman = fs.readFileSync('./Lagu Nya Kawan/herman4.mp3');
client.sendMessage(from, ItsMeHerman, MessageType.audio, {quoted: ftroli, mimetype: 'audio/mp4', ptt:true})
              break
      case 'rules':
      case 'sourcecode':
              textImg(`https://youtu.be/l8DWicsrW_4`)
