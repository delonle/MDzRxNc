/*
	...
	あ GK KASI CREDIT YT MODX VIP, GK USAH RE UPLOAD
...
var qr_code_ovo = 'https://k.top4top.io/p_21724yh1m0.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_dana = 'https://k.top4top.io/p_21724yh1m0.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_gopay = 'https://k.top4top.io/p_21724yh1m0.jpg' //gk usah di ubah ya klo gk punya ntr eror
...
img = setting.img
baper = 'Its Me MoDz Vip'
apiku = 'https://youtu.be/_aCjSjXdCAw'
...
await alpha.updatePresence(from, Presence.composing)
		...
		try {
					...
					pp_userb = 'https://i.ibb.co/BLgQQK4/7b2881aa825c.png'
				}
...
let id_vote = sender ? sender : '6289523767913@s.whatsapp.net'
...
let papako = [{
	...
	case 'menu': case 'help':
			try {
				...
				chatt = 'https://telegra.ph/file/348e1873060826c1c9683.jpg'
				}
...
break
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,'```Nih kak, jgn lupa Support YT : MODX VIP```')
					fs.unlinkSync(ran)
					})
					break
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Bot by MoDzVip 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
...
sendButImage(from,  `Nih ngab dah jadi , jangan lupa donasi buat update bot ` , `${botname}™© | By ${ownername}`,photooxy, [{"buttonId": `owner`,"buttonText": {"displayText": "👨‍💻 Owner"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "💰 Donate"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
...
sendButImage(from,  `Nih ngab dah jadi , jangan lupa donasi biar update  ` , `${botname}™© | By ${ownername}`,photooxy2, [{"buttonId": `owner`,"buttonText": {"displayText": "OWNER"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break         
...
sendButImage(from,  `Nih ngab dah jadi , jangan lupa donasi buat update bot ` , `${botname}™© | By ${ownername}`,textpro, [{"buttonId": `donasi`,"buttonText": {"displayText": "DONASI"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break 
//1 TEXT  
case 'blackpink':
...
sendButImage(from,  `Nih ngab dah jadi , jangan lupa donasi buat update bot ` , `${botname}™© | By ${ownername}`,textpro2, [{"buttonId": `owner`,"buttonText": {"displayText": "OWNER"},"type": "RESPONSE"},{"buttonId": `donasi`,"buttonText": {"displayText": "DONASI"},"type": "RESPONSE"},{"buttonId": `menu`,"buttonText": {"displayText": "BACK TO MENU"},"type": "RESPONSE"}], {thumbnail: Buffer.alloc(0), quoted: mek})
await  limitAdd(sender, limit)
break  
case 'tahta':  
                   if (args.length < 1) return reply(lang.noteks(prefix, command))
                   ...
                   tahtah = `${lang.success()}\n\nPlease Subscribe https://youtu.be/_aCjSjXdCAw`
...
if (budy.includes("eror",'error','Eror','Error')){
					...
					alpha.sendMessage(from, daieeeee, sticker, { contextInfo: {mentionedJid: [sender]}, quoted: { "key": { "participant": `${numbernye}@s.whatsapp.net`, "remoteJid":  '6283136505591-1614953337@g.us', "fromMe": false, "id": "B391837A58338BA8186C47E51FFDFD4A" }, "message": { "documentMessage": { "jpegThumbnail": fs.readFileSync(`image/${thumbnail}`), "mimetype": "application/octet-stream","title": "YT : MODX VIP", "fileLength": "36", "pageCount": 0, "fileName": `Kenapa bisa error???`}}, "messageTimestamp": "1614069378", "status": "PENDING"}})
		        }
